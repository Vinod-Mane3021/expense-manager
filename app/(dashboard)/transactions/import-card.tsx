                ...
                <CardContent className="flex flex-col gap-8">
                    <div>
                        <div className="flex items-center gap-5">
                            <Dot color="#71717a" className="size-3 bg-[#71717a] rounded-full" /><p>{"-->"} you are skipping these column</p>
                        </div>
                        <div className="flex items-center gap-5">
                            <Dot color="#3b82f6" className="size-3 bg-[#3b82f6] rounded-full" /><p>{"-->"} you are adding these column in your transaction history</p>
                        </div>
                    </div>
                    <ImportTable
                        headers={headers}
